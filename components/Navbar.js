...
const Navbar = () => {
  ...
  return (
    <>
      {showNavbar && (
        <nav className='bg-white w-[85vw] fixed top-14 right-[7vw] rounded-full p-3 px-7 flex items-center justify-between'>
        
          <div className="logo flex gap-20  items-center">
            <Link href="/generate">
              <svg className='h-7' viewBox="0 0 1176 238" title="Linktree Logo" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="hidden md:flex gap-4 font-bold">
            <button className='login p-4 rounded-lg px-6 bg-[#E9E9E9]'>Login</button>
            <button className="freesign bg-black text-white p-6 rounded-full">Sign Up Free</button>
          </div>
          ...
          {isMenuOpen && (
            <div className='md:hidden absolute top-16 left-0 right-0 bg-white rounded-lg shadow-lg p-4'>
              ...
              <div className='mt-4 space-y-4'>
                <button className='login w-full p-4 rounded-lg bg-[#E9E9E9]'><UserButton /></button>
                <button className="freesign w-full bg-black text-white p-4 rounded-full">Sign Up Free</button>
              </div>
            </div>
          )}
        </nav>
