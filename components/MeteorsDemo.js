      ...
      <div className=" w-full relative max-w-xs">
        ...
        <div
          ...
          <p className="font-normal text-base text-slate-500 mb-4 relative z-50">
            Check out my projects below and feel free to explore the source code
            by clicking the button. I have a linktree with all my projects and
            social media links so you can easily find what you need. I also have
            a GitHub where you can find all my open source projects. I have a
            discord server where you can chat with me and other developers about
            projects and other tech related topics.
          </p>
